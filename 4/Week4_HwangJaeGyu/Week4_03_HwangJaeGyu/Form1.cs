...
namespace Week4_03_HwangJaeGyu
{
    public partial class Form1 : Form
    {
        ...
        double[,] scores = new double[10,3]; //3*10
        int index = 0;


        private void btnInsert_Click(object sender, EventArgs e)
        {
            if(index >= scores.GetLength(0))//10
            {
                lblOutput.Text = "더 이상 입력을 할 수 없습니다.";
                return;
            }
            ...
            if(false == double.TryParse(tbxKor.Text, out kor)
                ...
                ||false == double.TryParse(tbxMath.Text, out mat))
            {
                lblOutput.Text = "숫자를 입력해주세요.";
                return;
            }
            ...
            if(kor < 0.0|| kor>100.0
               ...
               ||mat < 0.0 || mat > 100.0)
            {
                lblOutput.Text = "0~100사이의 점수를 입력해주세요.";
                return;
            }
            ...
            lblOutput.Text = $"국어: {kor} 영어: {eng} 수학: {mat} 입력 완료.";
